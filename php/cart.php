...
<body>
    <main class="cart-page">
        ...
        <form method="post" class="coupon-form">
            <input type="text" id="coupon_code" name="coupon_code" placeholder="Введите промокод" value="<?= $appliedCoupon ?>">
            <button type="submit" name="apply_coupon" class="btn apply">Применить</button>
            <?php if ($appliedCoupon): ?>
                <button type="submit" name="remove_coupon" class="btn remove-coupon">Удалить промокод</button>
            <?php endif; ?>
        </form>
                    ...
                    <div class="cart-item">
                        ...
                        <div class="item-details">
                            ...
                            <form method="post" style="margin-top: 10px;">
                                <input type="hidden" name="item_key" value="<?= $itemKey ?>">
                                <button type="submit" name="remove_item" class="btn small" onclick="return confirm('Вы уверены?')">Удалить</button>
                            </form>
